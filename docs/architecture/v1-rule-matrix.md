...
| LIP-004 | Lp(a) elevated | value above unit-specific threshold | unit explicit, interpretable | hard | limited | inform, clinician_clarification | no recurring missing penalty |
...
| INF-001 | hs-CRP elevated | value above target policy | assay known, interpretable | hard | yes | inform, monitor, clinician_clarification | assay-aware only |
| INF-002 | CRP without assay clarity | value exists | assay unknown | hard | no | collect_more_data, inform | interpretation limited |
| SUP-001 | Vitamin D below policy target | interpretable value present | unit explicit | medium | no | inform, monitor, behavior_adjustment | policy target, not consensus disease claim |
| SUP-002 | Ferritin elevated | interpretable value present | context gate incomplete | medium | no | inform, collect_more_data | do not escalate alone |
| SUP-003 | Ferritin elevated with context | ferritin elevated plus context signals | CRP/liver/iron context available | medium | no | inform, clinician_clarification | still not hard core score |
| SUP-004 | B12 low | interpretable value present | unit explicit | medium | no | inform, monitor, behavior_adjustment | supporting layer |
| SUP-005 | Magnesium low | interpretable value present | unit explicit | medium | no | inform, monitor | bounded interpretation |
| CTX-001 | DAO low | contextual marker abnormal | unit explicit | soft | no | inform, monitor | contextual only |
...
| WEE-002 | Weekly lowest pillar | one pillar lower than others | valid weekly scores present | medium | no | inform, behavior_adjustment | simple coaching layer |
...
| COV-003 | Assay missing | assay-dependent marker lacks assay type | raw value exists | hard | no | collect_more_data | especially relevant for CRP |
