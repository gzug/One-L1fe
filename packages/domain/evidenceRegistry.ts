...
export const evidenceSources: Record<string, EvidenceSource> = {
  ...
  src_b12_policy_v1: {
    sourceId: 'src_b12_policy_v1',
    title: 'B12 sufficiency and functional-marker context anchor for V1',
    publisher: 'One L1fe evidence registry',
    year: 2026,
    canonicalUrlOrDoi: 'internal://docs/research/v1-targeted-research-reconciliation-2026-04-12#b12',
    sourceType: 'expert_synthesis',
    biomedicalEvidenceClass: 'C',
    authorityLevel: 'medium',
    bucket: 'secondary',
    mainUsableContribution: 'Anchors B12 sufficiency floor at 400 pg/mL; notes that serum B12 is a poor proxy for functional status.',
    mainWeakness: 'Serum B12 lacks functional specificity; MMA context required for high-confidence deficiency judgment.',
  },
  src_magnesium_policy_v1: {
    sourceId: 'src_magnesium_policy_v1',
    title: 'Magnesium serum-proxy and functional-status anchor for V1',
    publisher: 'One L1fe evidence registry',
    year: 2026,
    canonicalUrlOrDoi: 'internal://docs/research/v1-targeted-research-reconciliation-2026-04-12#magnesium',
    sourceType: 'expert_synthesis',
    biomedicalEvidenceClass: 'C',
    authorityLevel: 'medium',
    bucket: 'secondary',
    mainUsableContribution: 'Anchors serum magnesium interpretation while noting it is a weak proxy for intracellular stores.',
    mainWeakness: 'Serum magnesium is tightly regulated and may not reflect total body status until severe depletion.',
  },
};
...
export const ruleEvidenceLinks: Record<string, RuleEvidenceLink> = {
  ...
  'SUP-003': {
    ruleId: 'SUP-003',
    biomarkerOrTopic: 'B12',
    logic: 'Bounded sufficiency flag when value below 400 pg/mL.',
    description: 'B12 is a supporting nutrient marker; score contribution suppressed via evidenceConfidenceModifier.',
    origin: 'evidence_extrapolated',
    anchorSourceId: 'src_b12_policy_v1',
    supportingSourceIds: [],
    productEvidenceClass: 'P1',
    status: 'active',
  },
  'SUP-004': {
    ruleId: 'SUP-004',
    biomarkerOrTopic: 'Magnesium',
    logic: 'Bounded sufficiency flag when value below 1.8 mg/dL.',
    description: 'Magnesium is a supporting mineral-status marker; score contribution suppressed via evidenceConfidenceModifier.',
    origin: 'evidence_extrapolated',
    anchorSourceId: 'src_magnesium_policy_v1',
    supportingSourceIds: [],
    productEvidenceClass: 'P1',
    status: 'active',
  },
